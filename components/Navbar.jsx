        ...
        <div className="relative flex h-20 items-center justify-between">
          <div className="absolute inset-y-0 right-0 flex items-center md:hidden">
            ...
            <button
              ...
              aria-expanded="false"
              onClick={() => setIsMobileMenuState((prev) => !prev)}
            >
            ...
            <div className="absolute inset-y-0 left-0 flex items-center pl-2 md:static md:inset-auto md:ml-6 md:pl-0">
              <Link href="messages" className="relative group ml-2">
                ...
                >
                  ...
                  <span className="sr-only">مشاهده اعلانات</span>
                  <svg
                    className="h-6 w-6"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              <div className="relative ml-3">
                <div>
                  <button
                    ...
                    aria-expanded="false"
                    aria-haspopup="true"
                    onClick={() => setIsProfileMenuState((prev) => !prev)}
                  >
                    <span className="absolute -inset-1.5"></span>
                ...
                {isProfileMenuState && (
                  <div
                    id="user-menu"
                    className=" absolute right-0 z-10 mt-2 w-48 origin-top-left rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                    role="menu"
